			...
			<section id="two" class="wrapper style2">
				<div class="inner">
					<div class="box">
						<div class="content">
									<div class="container">
					<a href="regis_auto.php" style='margin-left: 380px; margin-right:10px' class="button alt">Auto Registration</a>
					<a href="regis_cab.php" class="button" >Cab Registration</a></div><br>
							<header class="align-center">
							...
							<?php
								...
								if(isset($_POST['name'])&&isset($_POST['num'])&&isset($_POST['phnum'])&&isset($_POST['spcode'])&&isset($_POST['passwd']))
								{
									...
									$query ="INSERT INTO `auto_db`(`regnum`, `name`, `phnum`, `passwd`, `spcode`, `type`) VALUES ('$num','$name','$phnum','$md5','$spcode','c')";
									mysqli_query($conn,$query);
									header('Location:http://localhost/spardha/admin/regis_cab.php?done');
									$msg1="Dear $name,\nYour are Subscribed\nYour UserId:$phnum\np\Password:$passwd\nYour Spcode:$spcode";
                            ...
                            <form action='regis_cab.php' method='post' onsubmit='return validate();'>
		 						<table class="alt">
									
									<tbody>
									
										<tr>
											<td  style="color:black;">Cab Registration Number</td>
