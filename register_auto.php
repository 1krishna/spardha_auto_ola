	...
	<body>
		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="container">
					<a href="register_auto.php" style='margin-left: 400px;' class="button">Book Auto</a>
					<a href="register_car.php" class="button alt" >Book Car</a></div><br>
					<h3 style='margin-left: 400px'>Book Auto</h3>
							<div class="table-wrapper" style='margin-left: 400px;margin-right: 400px;'>
                            <form action='session1.php' method='get' onsubmit='return validate();'>
								<table class="alt">
									...
									<tbody>
										...
										<tr>
											<td>Email</td>
											<td><input type="email" value="" class="special" name="mail" id="mail"  /><span id="erre" style='color:red;' ></span></td>
										</tr>
										<tr>
								...
								<input type="checkbox" id="human" name="human" value="one" onblur="validate()"" >
...
<SCRIPT type='text/javascript'>
	function validate() {
        ...
        rn = /^[0-9]{12}$/; 
		 if(!rn.test(phnum))
		{
			document.getElementById("errp").innerHTML="Enter A Valid Number Of 12 Digits include (91)";
			re=false;
		}
