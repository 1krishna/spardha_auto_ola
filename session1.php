    <?php
      ...
      $_SESSION['start']=1;
        	...
        	$query = "INSERT INTO `bookings`(`name`, `phnum`, `email`, `pick_address`, `pick_area`, `drop_address`, `drop_area`, `otp`, `valied`, `time`,`type`) VALUES ('$name','$phnum','$email','$pick_add','$pick_area','$drop_add','$drop_area','$otp','0',CURRENT_TIMESTAMP,'a')";
